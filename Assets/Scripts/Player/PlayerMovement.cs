...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update() {
        ...
        _running = _holdingRunKey && (playerInput.z > 0 || _playerPerks.HasPerks(Perks.BETTER_RUN) || _playerPerks.HasSideMixPerk(Perks.BETTER_RUN) || _playerPerks.HasMainMixPerk(Perks.BETTER_RUN));
        if(_running) {
