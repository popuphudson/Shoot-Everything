...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        {
            m_target = (RebindActionUI)target;
            ...
            m_CancelButtonProperty = serializedObject.FindProperty("m_CancelButton");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_CancelButtonProperty);
            }
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                if(m_target.m_OverrideActionLabel) EditorGUILayout.PropertyField(m_ActionLabelStringProperty);
            }
        ...
        private RebindActionUI m_target;
        ...
        private SerializedProperty m_CancelButtonProperty;
